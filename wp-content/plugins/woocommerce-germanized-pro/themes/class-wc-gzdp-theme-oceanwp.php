...
class WC_GZDP_Theme_OceanWP extends WC_GZDP_Theme {
	...
	public function remove_gzd_compatibility() {
		...
		wc_gzdp_remove_class_action( 'ocean_after_single_product_price', 'OceanWP_WooCommerce_Config', 'woocommerce_germanized_single' );
		wc_gzdp_remove_class_action( 'ocean_after_single_product_excerpt', 'OceanWP_WooCommerce_Config', 'woocommerce_germanized_single_meta' );
