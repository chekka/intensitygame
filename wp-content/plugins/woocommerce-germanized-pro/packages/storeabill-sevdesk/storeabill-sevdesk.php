<?php
/**
 * Plugin Name: StoreaBill sevDesk
 ...
 * License: GPLv3
 *
 * @package Vendidero/StoreaBill/sevDesk
 * @internal This file is only used when running the sevDesk integration as a feature plugin.
 */
	...
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
		error_log(  // phpcs:ignore
			...
			/* translators: 1: composer command. 2: plugin directory */
				esc_html_x( 'Your installation of the StoreaBill sevDesk feature plugin is incomplete. Please run %1$s within the %2$s directory.', 'sevdesk', 'woocommerce-germanized-pro' ),
				'`composer install`',
