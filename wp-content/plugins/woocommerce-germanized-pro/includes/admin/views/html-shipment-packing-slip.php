...
<div class="wc-gzd-shipment-packing-slip column column-spaced col-12" data-packing_slip="<?php echo esc_attr( $packing_slip ? $packing_slip->get_id() : '' ); ?>">
		...
		<div class="wc-gzd-shipment-packing-slip-content">
			<div class="shipment-packing-slip-actions">
				<div class="shipment-packing-slip-actions-wrapper shipment-packing-slip-create">
					...
					<a class="create-packing-slip" href="#" title="<?php esc_html_e( 'Refresh packing slip', 'woocommerce-germanized-pro' ); ?>"><?php esc_html_e( 'Refresh', 'woocommerce-germanized-pro' ); ?></a>
	...
	<?php else : ?>
		<a class="button button-secondary create-packing-slip" href="#" title="<?php esc_html_e( 'Create packing slip', 'woocommerce-germanized-pro' ); ?>"><?php esc_html_e( 'Create', 'woocommerce-germanized-pro' ); ?></a>
	<?php endif; ?>
</div>
