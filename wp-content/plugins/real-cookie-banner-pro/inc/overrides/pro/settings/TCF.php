...
trait TCF {
    ...
    public function localize($arr, $context) {
        ...
        $isFrontend = $context === \DevOwl\RealCookieBanner\Assets::$TYPE_FRONTEND || is_customize_preview();
        ...
        if (($isFrontend && $isActive) || $context === \DevOwl\RealCookieBanner\Assets::$TYPE_ADMIN) {
