...
use DevOwl\RealCookieBanner\presets\pro\blocker\HappyFormsPreset as BlockerHappyFormsPreset;
 ...
 */
class HappyFormsPreset extends \DevOwl\RealCookieBanner\presets\pro\blocker\HappyFormsPreset {
    ...
    public function common() {
        ...
        return \array_merge($parent, [
            'attributes' => \array_merge(
                [
                    'name' => __(
                        'HappyForms with Google reCAPTCHA',
