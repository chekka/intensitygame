...
use DevOwl\RealCookieBanner\presets\pro\blocker\DiviContactFormPreset as BlockerDiviContactFormPreset;
 ...
 */
class DiviContactFormPreset extends \DevOwl\RealCookieBanner\presets\pro\blocker\DiviContactFormPreset {
    ...
    public function common() {
        ...
        return \array_merge($parent, [
            'attributes' => \array_merge(
                [
                    'name' => __(
                        'Divi Contact Form with Google reCAPTCHA',
