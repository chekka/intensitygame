...
use DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\view\PluginUpdateView;
use WP_Error;
...
class LicenseActivation {
    ...
    public function skip($noUsage = \false) {
        ...
        $license->switch();
        update_option(
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_TELEMETRY_PREFIX .
                $slug,
            \false
        );
        update_option(
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_INSTALLATION_TYPE_PREFIX .
                $slug,
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::INSTALLATION_TYPE_PRODUCTION
        );
        update_option(
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_NO_USAGE_PREFIX .
                $slug,
            $noUsage
        );
        $result = update_option(
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_CODE_PREFIX .
                $slug,
            ''
        );
        $license->restore();
    ...
    public function activate($code, $installationType, $telemetry, $newsletterOptIn, $firstName, $email) {
        ...
        if (!empty($this->getCode())) {
            ...
            if (!is_wp_error($result)) {
                ...
                update_option(
                    \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_UUID_PREFIX .
                        $slug,
                    $uuid
                );
                update_option(
                    \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_HOST_NAME .
                        $slug,
                    \base64_encode(
                        \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Utils::getCurrentHostname()
                    )
                );
                ...
                delete_option(
                    \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_HINT_PREFIX .
                        $slug
                );
                ...
                if ($initiator->isExternalUpdateEnabled()) {
                    update_option(
                        \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\view\PluginUpdateView::OPTION_NAME_ADMIN_NOTICE_LICENSE_DISMISSED_DAY_PREFIX .
    ...
    public function deactivate($remote = \false, $validateStatus = null, $help = '') {
        ...
        update_option(
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_INSTALLATION_TYPE_PREFIX .
                $slug,
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::INSTALLATION_TYPE_NONE
        );
    ...
    public function getReceived() {
        ...
        $license->switch();
        $result = get_option(
            \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\license\License::OPTION_NAME_LICENSE_ACTIVATION_PREFIX .
                $license->getSlug()
        );
        $license->restore();
        return $result;
