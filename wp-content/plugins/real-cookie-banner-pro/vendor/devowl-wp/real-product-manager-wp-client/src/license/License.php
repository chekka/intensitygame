...
class License {
    ...
    public function update_option_siteurl() {
        $currentHostname = \DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Utils::getCurrentHostname();
    ...
    public function validateNewHostName() {
        ...
        if (
            !\DevOwl\RealCookieBanner\Vendor\DevOwl\RealProductManagerWpClient\Utils::isRedirected() &&
            $isLicensed &&
