    ...
    public function localizeScript($context) {
        ...
        $restQuery = apply_filters('DevOwl/Utils/RestQuery', [
            '_v' => $this->getPluginConstant(
                \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_VERSION
            ),
        ...
        return [
            'slug' => $this->getPluginConstant(
                \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_SLUG
            ),
            ...
            'restUrl' => $this->getAsciiUrl(\DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\Service::getUrl($this)),
            'restNamespace' => \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\Service::getNamespace($this),
...
',
    ...
    public function getChunkTranslationMap() {
        $inc = $this->getPluginConstant(
            \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_INC
        );
    ...
    protected function getTranslationSuffixByBasename($basename) {
        ...
        $path = $this->getPluginConstant(
            \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_PATH
        );
    ...
    protected function probablyEnqueueComposerChunk($handle, $src, &$deps, $in_footer, $media) {
        $rootSlug = $this->getPluginConstant(
            \DevOwl\RealCookieBanner\Vendor\MatthiasWeb\Utils\PluginReceiver::$PLUGIN_CONST_ROOT_SLUG
        );
