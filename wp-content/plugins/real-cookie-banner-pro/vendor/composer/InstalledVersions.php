...
use DevOwl\RealCookieBanner\Vendor\Composer\Autoload\ClassLoader;
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('DevOwl\\RealCookieBanner\\Vendor\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
        if (self::$canGetVendors) {
            foreach (\DevOwl\RealCookieBanner\Vendor\Composer\Autoload\ClassLoader::getRegisteredLoaders() as $vendorDir => $loader) {
