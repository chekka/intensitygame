...
if (!class_exists('PluginUpdateChecker_3_1', false)) :
	...
	class PluginUpdateChecker_3_1
	{
		 ...
		 */
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 168, $optionName = '', $muPluginFile = '')
		{
...
if (!class_exists('PucScheduler_3_1', false)) :
	...
	{
		public $checkPeriod = 168; //How often to check for updates (in hours).
		...
		public function __construct($updateChecker, $checkPeriod)
		{
			...
			if ($this->checkPeriod > 0) {
				...
				//Reset daily cron to weekly 
				if (wp_get_schedule($this->cronHook) === 'daily') {
...
if (!class_exists('PucFactory', false)) :
	...
	class PucFactory
	{
		 ...
		 */
		public static function buildUpdateChecker($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 168, $optionName = '', $muPluginFile = '')
		{
