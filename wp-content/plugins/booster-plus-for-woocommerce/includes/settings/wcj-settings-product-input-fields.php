...
for ( $i = 1; $i <= $input_fields_global_total_num;  $i++ ) {
	...
	foreach ( $options as $option ) {
		if ( ! isset( $option['desc_tip'] ) && 'wcj_product_input_fields_enabled_global_' === $option['id'] ) {
			$option['desc_tip'] = wp_kses_post( 'key: <code>_wcj_product_input_fields_global_' . $i . '</code>', 'woocommerce-jetpack' );
		}
		$settings = array_merge(
			$settings,
			array(
	...
	wcj_maybe_convert_and_update_option_value(
		array(
			array(
				'id'      => 'wcj_product_input_fields_in_products_global_' . $i,
				'default' => '',
			),
			array(
				'id'      => 'wcj_product_input_fields_ex_products_global_' . $i,
				'default' => '',
			),
		),
	...
	$settings = array_merge(
		...
		array(
			array(
				...
				'id'       => 'wcj_product_input_fields_in_cats_global_' . $i,
				'default'  => '',
				'type'     => 'multiselect',
				'class'    => 'chosen_select',
				'css'      => 'width: 450px;',
			...
			array(
				...
				'desc_tip' => __( 'Leave blank to include all products.', 'woocommerce-jetpack' ),
				'id'       => 'wcj_product_input_fields_ex_cats_global_' . $i,
				'default'  => '',
				'type'     => 'multiselect',
				'class'    => 'chosen_select',
				'css'      => 'width: 450px;',
			...
			array(
				...
				'desc_tip' => __( 'Leave blank to include all products.', 'woocommerce-jetpack' ),
				'id'       => 'wcj_product_input_fields_in_tags_global_' . $i,
				'default'  => '',
				'type'     => 'multiselect',
				'class'    => 'chosen_select',
				'css'      => 'width: 450px;',
			...
			array(
				...
				'desc_tip' => __( 'Leave blank to include all products.', 'woocommerce-jetpack' ),
				'id'       => 'wcj_product_input_fields_ex_tags_global_' . $i,
				'default'  => '',
				'type'     => 'multiselect',
				'class'    => 'chosen_select',
				'css'      => 'width: 450px;',
