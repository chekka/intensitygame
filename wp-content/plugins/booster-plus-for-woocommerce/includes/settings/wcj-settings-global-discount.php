...
$discount_groups_num = apply_filters( 'booster_option', 1, wcj_get_option( 'wcj_global_discount_groups_total_number', 1 ) );
for ( $i = 1; $i <= $discount_groups_num; $i++ ) {
		...
		array(
			...
			array(
				...
				'desc_tip' => sprintf(
					...
					__( 'Will apply selected function and coefficient to the final price, e.g.: %s.', 'woocommerce-jetpack' ),
