<?php
/**
 * Booster Plus for WooCommerce - Settings - Add to Cart
 *
 * @version 5.6.4
 * @since   2.8.0
 * @author  Pluggabl LLC.
...
$wcj_add_to_cart_per_category_total_groups_number = apply_filters( 'booster_option', 1, wcj_get_option( 'wcj_add_to_cart_per_category_total_groups_number', 1 ) );
for ( $i = 1; $i <= $wcj_add_to_cart_per_category_total_groups_number; $i++ ) {
