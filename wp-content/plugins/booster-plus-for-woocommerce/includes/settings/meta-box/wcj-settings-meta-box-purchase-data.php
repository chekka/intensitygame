...
foreach ( $products as $product_id => $desc ) {
	$product_options = array(
		...
		array(
			...
			'desc'       => $desc,
			'product_id' => $product_id,
			'meta_name'  => '_wcj_purchase_price_extra',
		...
		array(
			...
			'desc'       => $desc,
			'product_id' => $product_id,
			'meta_name'  => '_wcj_purchase_price_affiliate_commission',
	...
	for ( $i = 1; $i <= $total_number; $i++ ) {
		...
		$product_options[] = array(
			...
			'desc'       => $desc,
			'product_id' => $product_id,
			'meta_name'  => '_wcj_purchase_price_custom_field_' . $i,
			'enabled'    => 'yes',
		);
	}
	$product_options = array_merge(
		$product_options,
		array(
			array(
			...
			array(
				...
				'desc'       => $desc,
				'product_id' => $product_id,
				'meta_name'  => '_wcj_purchase_partner',
