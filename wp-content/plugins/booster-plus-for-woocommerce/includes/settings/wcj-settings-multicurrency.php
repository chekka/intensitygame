...
$settings       = array(
	...
	array(
		'title'    => __( 'Set Currency By Customer Country', 'woocommerce-jetpack' ),
		'desc'     => __( 'Enable', 'woocommerce-jetpack' ),
		'desc_tip' => __( 'If you want to use mullticurrency  switcher based on IP location based Please Enable.', 'woocommerce-jetpack' ),
		'id'       => 'wcj_multicurrency_set_customer_ip_currency',
		'default'  => 'no',
		'type'     => 'checkbox',
	),
	array(
