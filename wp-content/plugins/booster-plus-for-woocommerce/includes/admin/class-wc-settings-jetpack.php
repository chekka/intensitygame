    ...
    class WC_Settings_Jetpack extends WC_Settings_Page
{
        ...
        public function create_free_version_notice_about_reasons_to_upgrade()
    {
            ...
            ?>
                <style>
                  .wcj-button.button { margin: 2px 0 14px 0; }
                  .wcj-list { vertical-align: top; width: 47%; display: inline-block; margin: 0 3% 10px 0; }
                  @media screen and (max-width: 782px) {
                    .wcj-list { width: 100%; }
                    .wcj-list { margin-bottom: 0; }
                    .wcj-list-right { margin-bottom: 10px; }
                 }
                 .wcj-list li:before { content: '+'; margin: 0 5px 0 0; }
                 .wcj-list-right {}
                 .wcj-notice-title { margin: 5px 0 15px 0; }
                 .wcj-notice-wrapper { margin: 0.5em 0; padding: 2px; font-size: 13px; line-height: 1.5; }
              </style>
<?php
                ...
                <div class="subCircles">
                    <div class="sub-circle">
                        <div class="form_label">
                            ...
                            <label><?php _e('Suggest a feature', 'woocommerce-jetpack');?></label>
                            <div class="ic_list">
                    ...
                    <div class="sub-circle">
                        ...
                        <div class="form_label">
                            <label><?php _e('Booster Free Support (72 business hours response)', 'woocommerce-jetpack');?></label>
                    ...
                    <div class="sub-circle">
                        ...
                        <div class="form_label">
                            <label><?php _e('Booster Plus Premium Support (4 hours - 24 hours response)', 'woocommerce-jetpack');?></label>
...
<?php
        ...
        public function output_sections_submenu()
    {
            ...
            if ('dashboard' === $current_cat) {
                ...
                $sections['all_module'] = '<span><img src="'.wcj_plugin_url().'/assets/images/multiple 1.png"></span>'.__('All Plugins', 'woocommerce-jetpack');
                $sections['active'] = '<span><img src="'.wcj_plugin_url().'/assets/images/t-swich.png"></span>' .__('Active Plugins', 'woocommerce-jetpack');
 ...
 <table class="wp-list-table widefat striped plugins">
    <thead>
        <tr>
            ...
            <?php _e('Plugin', 'woocommerce-jetpack');?></th>
    ...
    <tfoot>
        <tr>
            ...
            <th scope="col" class="manage-column column-name" style=""> <?php _e('Plugin', 'woocommerce-jetpack');?>
            </th>
...
$html = '';
    ...
    <p style="color:#000;font-size:12px;font-style:italic;">
                <?php echo __('Total Plugins:') . ' ' . $total_modules; ?>
          </p>
    </div>
<?php
}
    ...
    public function disable_autoload_options_from_section($settings)
    {
        ...
        global $wpdb;
        $sql = "UPDATE {$wpdb->options} SET autoload = 'no' WHERE option_name IN ({$fields_ids_str}) AND autoload != 'no'";
        $wpdb->query($sql);
    }
