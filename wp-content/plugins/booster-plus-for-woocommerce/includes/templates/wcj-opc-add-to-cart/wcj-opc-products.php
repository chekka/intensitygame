                ...
                <div class="wcj_opc_col wcj_opc_add_to_cart col-md-3">
                    <?php
                        if ( $product->is_in_stock() ) {
                            ?>
                            <button class="wcj_opc_loader button wcj_opc_add_to_cart_btn" id="product_<?php echo $product->get_id(); ?>" name="product_id" value="<?php echo $product->get_id(); ?>" data-opc_product_id="<?php echo $product->get_id(); ?>">
