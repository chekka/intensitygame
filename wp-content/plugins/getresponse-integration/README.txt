...
6. Connect your **GetResponse** account. Here's how to do it:
	...
	* Copy and paste the GetResponse API key you can find in **Profile>>Integrations & API>>API** in your **GetResponse** account. (If you are GetResponse MAX client, check the checkbox to confirm you have the **MAX package, choose your account type, and enter your GetResponse MAX domain).
	* Click **Connect**.
...
* Added GetResponse API verification step in plugin help section

= v5.5.28 =

* Fix for Post update - undefined wc_enqueue_js function

= v5.5.27 =

* Fix for LandingPages - added esc_html function

= v5.5.26 =

* TrackingCode security issue resolved

= v5.5.25 =

* LPS code snippet sanitized
...
* Added fix for new order - cart should be removed (abandon cart issue)
* Fix for security issue - CSRF form validation added
...
* Fixed - Contact Form 7 values from select component sent as array

= v5.5.17 =

* Fixed - Skipping products with missing product variant ID or missing product variant in the cart

= v5.5.16 =

* Fixed - cleanup in css (removed global styles)

= v5.5.15 =

* Fixed - tooltip css class rename
* Fixed - api_key variable checking on TinyMCE editor
* Fixed - readding a deleted product in GetResponse store

= v5.5.14 =

* Fixed - error on deleting last variant for product

= v5.5.13 =

* Fixed - mb_convert_encoding for PHP < 7.2

= v5.5.12 =

* Fixed - XSS vulnerability in plugin settings
* Fixed - Validation error on updating product variant

= v5.5.11 =

* Fixed - utf8 payload encoding.
...
* Fixed - max package connection.

= v5.5.8 =

* Fixed - retrieving customer for export.

= v5.5.7 =

* Fixed - selected list validation.

= v5.5.6 =

* Fixed - GetResponse API timeout.

= v5.5.5 =

* Fixed - use mbstring functions to truncate description

= v5.5.4 =

* Fixed - notice when API Response don't have httpStatus

= v5.5.3 =

* Added - disconnect when API Key doesn't exists.
* Fixed - fix for autoresponder checkbox
* Fixed - new instruction about API Key connection.

= v5.5.2 =

* Fix in exports - export guests accounts.
...
* Added custom fields in Contact Form 7.
* Fixed empty strings sent by API.
* Fixed footer links.
* Fixed Woocommerce product variant update.

= v5.4.8 =

* Fixed issue with multisite and contactForm7.

= v5.4.7 =

* Fixed get all webforms by API.

= v5.4.6 =

* Fixed update Autoresponder day when contact is updated.

= v5.4.5 =

* Fixed problem with product ids greater than 4294967295

= v5.4.4 =

* Fixed problem with loopback and Health Check timeouts

= v5.4.3 =

* Fixed problem with adding contact by comment in Wordpress 5.2
