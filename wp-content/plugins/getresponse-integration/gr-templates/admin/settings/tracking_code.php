...
<h2 class="nav-tab-wrapper"><?php gr_get_admin_tabs( 'gr-integration-tracking-code' ) ?></h2>
...
<form method="post" action="<?php echo esc_url(admin_url( 'admin.php?page=gr-integration-tracking-code' )) ?>">
    <table class="form-table subscription-settings gr_box">
        <tbody>
            <tr>
                <td class="subscription-settings-cell">
