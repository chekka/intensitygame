...
final class BWFAN_Core {
	...
	/**
	 * Admin notice if Autonami Pro older version active
	 */
	public function maybe_show_old_pro_notice() {
        ...
        <div class="notice notice-warning" style="display: block!important;">
            <p>
				<?php
				echo __( '<strong>Warning! Old version of Autonami Pro is detected.</strong> We strongly recommend to update the latest version of Autonami Pro.', 'wp-marketing-automations' );
				?>
            </p>
        </div>
		<?php
	...
	public function load_cli() {
		if ( defined( 'WP_CLI' ) && WP_CLI ) {
			/** v1 autonami cli command register */
			...
			/** v2 autonami cli command register */
