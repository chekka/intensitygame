(function ($) {
    ...
    let wc_checkout_coupon_field = {
        ...
        remove_field_el: '',
        init: function () {
            $(document.body).on('keyup focus', '.wfacp_coupon_code', wc_checkout_coupon_field.onenter);
            $(document.body).on('change focusout', '.wfacp_coupon_code', wc_checkout_coupon_field.remove_class);
